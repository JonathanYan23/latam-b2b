...
const en = {
  ...
  browse: {
    ...
    searchPlaceholder: "Search products or item No.…",
    category: "Category",
  ...
  wsProducts: {
    ...
    bulkUpload: "Bulk photo upload",
    bulkTitle: "Generate products in bulk",
    bulkHint:
      "Upload multiple photos to auto-generate product drafts, fill in name/item No./price, then select and create in one click.",
