...
const es = {
  ...
  browse: {
    ...
    searchPlaceholder: "Buscar productos o código…",
    category: "Categoría",
  ...
  wsProducts: {
    ...
    bulkUpload: "Subida masiva de fotos",
    bulkTitle: "Generar productos en masa",
    bulkHint:
      "Sube varias fotos para generar borradores de productos, completa nombre/código/precio y crea los seleccionados con un clic.",
